...
import { zhCN } from "date-fns/locale" // Add this import at the top of the file
...
export const VideoTopRow = ({ video }: VideoTopRowProps) => {
	...
	const compactDate = useMemo(() => {
		return formatDistanceToNow(video.createdAt, { addSuffix: true, locale: zhCN })
	}, [video.createdAt])
	const expandedDate = useMemo(() => {
		return format(video.createdAt, "dd MMM yyyy", { locale: zhCN })
	}, [video.createdAt])
